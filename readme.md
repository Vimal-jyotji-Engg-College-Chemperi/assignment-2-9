"""
Ring Leader Election Algorithm - IoT Network Simulation
Description:
This program simulates a Ring Leader Election Algorithm
used in distributed IoT networks. The node with the
...
class RingNetwork:
    ...
    def elect_leader(self, start_id):
        ...
        print(f"\nElection started from Node {start_id}")
